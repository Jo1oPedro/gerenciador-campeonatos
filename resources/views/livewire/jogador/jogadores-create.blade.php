        ...
        <div class="">
            <form class="w-full max-w-sm">
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="create-nome">
                        Nome
                    </label>
                    </div>
                    <div class="md:w-2/3">
                        <input class="form-control @error('nome') is-invalid @enderror appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" class="form-control @error('nome') is-invalid @enderror" id="create-nome" type="text" wire:model="nome">
                ...
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                        <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="create-idade">
                            Idade
                        </label>
                    </div>
                    <div class="md:w-2/3">
                        <input class="form-control @error('idade') is-invalid @enderror appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="create-idade" type="number" wire:model="idade">
                        <div class="invalid-feedback">
                            @error('idade')
                                {{$message}}
                            @enderror
                ...
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                        <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="create-nacionalidade">
                          Nacionalidade
                        </label>
                    </div>
                    <div class="md:w-2/3">
                        <input class="form-control @error('nacionalidade') is-invalid @enderror appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="create-nacionalidade" type="text" wire:model="nacionalidade">
                        <div class="invalid-feedback">
                            @error('nacionalidade')
                                {{$message}}
                            @enderror
