                    ...
                    <table class="w-full cursor-pointer">
                        <thead class="bg-gray-50 border-b-2 border-gray-200">
                            <tr>
                                ...
                                <th class="p-3 text-sm font-semibold tracking-wide text-left w-15">Jogadores do time</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="bg-white border-b transition durante-300 ease-in-out hover:bg-gray-100 ">
                                    ...
                                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                        <div class="inline-flex">
                                            <button class="bg-emerald-400 hover:bg-gray-400 text-white font-bold py-2 px-4 rounded-l" wire:click.prevent="getJogadores({{ $time->id }})" @click="jogadores = true">
                                                Visualizar jogadores do time 
                                            </button>
                                        </div>    
                                    </td>
                                </tr>
